...
def LEDControl_Handle(sms_body):
	on_numbers[1] = '5510451'
	on_numbers[2] = '5510595'
	on_numbers[3] = '5510915'
	on_numbers[4] = '5512451'
	on_numbers[5] = '5518595'
	
	off_numbers[1] = '5510460'
	off_numbers[2] = '5510604'
	off_numbers[3] = '5510924'
	off_numbers[4] = '5512460'
	off_numbers[5] = '5518604'
	
	# Get LED number
	led_number = sms_body[3]
	
	# Individual Lamp Cmd
	if led_number.isdigit():
		switch = sms_body[4:]
		
		if switch == 'on': code = on_numbers[int(led_number)]
		else:			   code = off_numbers[int(led_number)]
		else:			   code = '12345'
	...
	# All Lamps
	elif not led_number.isdigit():
		switch = sms_body[6:]
		
		for led_number in range(1,5):
			if switch == 'on': code = on_numbers[led_number]
			else:			   code = off_numbers[led_number]
			else:			   code = '12345'
